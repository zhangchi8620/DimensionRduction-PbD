...
#define mcar_min_position 0.3
#define mcar_max_position 0.4
#define mcar_max_velocity 0.001            // the negative of this is also the minimum velocity
